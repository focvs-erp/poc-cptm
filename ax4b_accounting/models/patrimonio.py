...
#     cod_forn_dados_seguro = fields.Many2one('account.forncedores_patrimonio')
    ...
    # depreciation_move_ids_societaria = fields.One2many('account.depreciacao_societaria', 'asset_id_societaria', string='Depreciation Lines', readonly=True, states={'draft': [('readonly', False)], 'open': [('readonly', False)], 'paused': [('readonly', False)]})
